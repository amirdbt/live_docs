...
const ShareModal = ({collaborators,creatorId,currentUserType,roomId}:ShareDocumentDialogProps) => {
    ...
    <DialogContent className='shad-dialog'>
      ...
      <div className='flex items-center gap-3'>
            <div className='flex flex-1 rounded-md bg-dark-400'>
                <Input id='email' placeholder='Enter your email' value={email} onChange={e => setEmail(e.target.value)} className='share-input' />
